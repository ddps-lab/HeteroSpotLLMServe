"""
Offline benchmark — Concurrent Initialization spot tolerance (Llama-3.1-70B long-context / Mooncake, Scenario A)
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Offline Benchmark — Concurrent Initialization Spot Tolerance — Scenario {SCENARIO}")
