"""
Online benchmark — On-Demand Only baseline (Llama-3.1-70B, Scenario A)
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "online_only_ondemand.json")
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Online Benchmark — On-Demand Only Baseline — Scenario {SCENARIO}")
