"""
ShuntServe Pipeline 4 (SS-P4)
g5.12xlarge×1, TP=[4], Layers=[64]
"""
import asyncio
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "shuntserve_p4.json")

# ─── Node assignment ─────────────────────────────────────────────────
# SS-P4: g5.12xlarge×1 (single node, TP=4)

NODE_LAYER_MAPPING = [
    (g5_12xlarge_node_ip_2, int(_pipeline["stages"][0][STAGE_LAYER_COUNT_IDX])),  # g5.12xlarge TP=4
]
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"ShuntServe Pipeline 4 — {PREDICTED_FILE}")
