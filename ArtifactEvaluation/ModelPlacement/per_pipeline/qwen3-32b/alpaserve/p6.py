...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "alpaserve_p6.json")

# ─── Node assignment ─────────────────────────────────────────────────
# AP-P6: g6e.xlarge×2 (homogeneous, TP=1 each)
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"AlpaServe Pipeline 6 — {PREDICTED_FILE}")
