"""
Performance Estimation Benchmark: Qwen/Qwen3-4B
...
NODE_LAYER_MAPPING = [
    # stage[0]: 5 layers (TP=1)
    (NODE_IP, 5),
    # stage[1]: 5 layers (TP=1)
    (NODE_IP, 5),
    # stage[2]: 5 layers (TP=1)
    (NODE_IP, 5),
    # stage[3]: 5 layers (TP=1)
    (NODE_IP, 5),
    # stage[4]: 4 layers (TP=1)
    (NODE_IP, 4),
    # stage[5]: 4 layers (TP=1)
    (NODE_IP, 4),
    # stage[6]: 4 layers (TP=1)
    (NODE_IP, 4),
    # stage[7]: 4 layers (TP=1)
    (NODE_IP, 4),
]
