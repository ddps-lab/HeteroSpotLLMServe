...
# HexGen pipelines may have many stages with mixed instance types.
# Adjust this mapping based on the optimizer output stages.
...
NODE_LAYER_MAPPING = [
    ...
    (g6e_xlarge_node_ip_3,  int(_pipeline["stages"][5][STAGE_LAYER_COUNT_IDX])),
    (g6e_xlarge_node_ip_4,  int(_pipeline["stages"][6][STAGE_LAYER_COUNT_IDX])),
    (g5_12xlarge_node_ip_1, int(_pipeline["stages"][7][STAGE_LAYER_COUNT_IDX])),
