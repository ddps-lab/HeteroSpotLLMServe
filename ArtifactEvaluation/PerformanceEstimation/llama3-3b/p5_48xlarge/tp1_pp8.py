...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "bench_p5_48xlarge_tp1_pp8.json")
...
# Fill in the IP address of the p5.48xlarge node.
...
async def test_benchmark():
    ...
    print(f"  Instance: p5.48xlarge (H100 ×8)")
