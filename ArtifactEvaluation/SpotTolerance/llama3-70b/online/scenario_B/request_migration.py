"""
Online benchmark — Request Migration spot tolerance (Llama-3.1-70B, Scenario B)
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "online_request_migration.json")
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Online Benchmark — Request Migration Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_online_request_migration_llama3_70b_scenario_{SCENARIO}",
