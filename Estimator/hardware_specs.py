...
INSTANCE_SPEC = {
    ...
    "p4d.24xlarge(single)": {"gpu_type": "A100_40GB", "gpu_count": 1, "interconnect": "NVSwitch 3.0"},
    "p5.48xlarge(single)":     {"gpu_type": "H100",       "gpu_count": 1, "interconnect": "NVSwitch 4.0"},
    "p5.48xlarge(double)":     {"gpu_type": "H100",       "gpu_count": 2, "interconnect": "NVSwitch 4.0"},
}