"""
vLLM Pipeline 1 (vL-P1)
g6.12xlarge×3, TP=[4,4,4], Layers=[22,21,21]
"""
import asyncio
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "vllm_p1.json")

# ─── Node assignment ─────────────────────────────────────────────────
# vL-P1: g6.12xlarge×3 (homogeneous, TP=4 each)
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"vLLM Pipeline 1 — {PREDICTED_FILE}")
