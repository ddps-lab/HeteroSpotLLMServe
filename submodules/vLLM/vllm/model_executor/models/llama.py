...
# Used to retrieve tensor information from the tensor server store
...
# Function registered on the manager server
# Specify DictProxy for client-side access
...
class LlamaForCausalLM(nn.Module, SupportsLoRA, SupportsPP):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        max_retries = 120 # max 600s (~10 min)
        wait_time = 5
        ...
        try:
            ...
            # Verify tensor dictionary is not empty
            if not TENSOR_DICT:
                raise ValueError("Tensor Dictionary is empty")
            # Tensor dictionary verification (temporary debugging)
