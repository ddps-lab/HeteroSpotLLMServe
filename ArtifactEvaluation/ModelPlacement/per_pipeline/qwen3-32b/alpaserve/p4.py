"""
AlpaServe Pipeline 4 (qwen3-32b)
...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "alpaserve_p4.json")

# ─── Node assignment (manual) ────────────────────────────────────────
NODE_LAYER_MAPPING = [
    # stage[0]: (spot)g5.12xlarge (TP=4) — replica 1
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"AlpaServe Pipeline 4 — Config loaded from {PREDICTED_FILE}")
