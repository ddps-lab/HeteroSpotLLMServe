...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "alpaserve_p5.json")

# ─── Node assignment ─────────────────────────────────────────────────
# AP-P5: g5.12xlarge (single node, TP=4)
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"AlpaServe Pipeline 5 — {PREDICTED_FILE}")
