"""
Online benchmark — ShuntServe spot tolerance (Llama-3.1-70B, Scenario A)
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "online_shuntserve.json")
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Online Benchmark — ShuntServe Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_online_shuntserve_scenario_{SCENARIO}",
