"""
Offline benchmark — AlpaServe (Llama-3.1-70B)
...
# AP-P1: g6.12xl#1, g6.12xl#2, g6.12xl#3  (TP=4 each)
# AP-P2: g5.12xl#1, g5.12xl#2              (TP=4 each)
# AP-P3: g6e.xl#1, g6e.xl#2, g6e.xl#3, g6e.xl#4  (TP=1 each)
