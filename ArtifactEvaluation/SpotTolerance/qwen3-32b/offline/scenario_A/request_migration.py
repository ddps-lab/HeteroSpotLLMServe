"""
Offline benchmark — Request Migration spot tolerance (Qwen3-32B, Scenario A)
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Offline Benchmark — Request Migration Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_offline_request_migration_qwen3_32b_scenario_{SCENARIO}",
