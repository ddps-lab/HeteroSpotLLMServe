...
class Worker(LocalOrDistributedWorkerBase):
    ...
    def __init__(
        ...
        # Used for tensor manager access during model and cache initialization
    ...
    def determine_num_available_blocks(self) -> Tuple[int, int]:
        ...
        # GPU blocks will be retrieved from the external Tensor Store.
        # Therefore, compute cpu blocks but handle gpu blocks via override.
        num_gpu_blocks = 0 # dummy
        num_cpu_blocks = max(num_cpu_blocks, 0)
...
def init_worker_distributed_environment(
    ...
    # Set up Global Group here. Parallel strategy is not needed yet
    init_distributed_environment(parallel_config.world_size, rank,
                                 distributed_init_method, local_rank)
    # Initialize model parallel groups.
    # Replaced with a new function added to parallel_state.py.
