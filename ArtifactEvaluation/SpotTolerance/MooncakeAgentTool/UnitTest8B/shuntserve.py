"""
Offline benchmark — ShuntServe spot tolerance unit test (Llama-3.1-8B-Instruct)

Single pipeline on 2x g6.xlarge with comprehensive spot event timeline:
  - First-stage-only swap
  - Non-first-stage-only swap
  - All stages swapped simultaneously
  - Same-time event grouping
  - Partial restore
"""
import asyncio
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Offline Benchmark — ShuntServe Spot Tolerance — UnitTest8B")
