...
async def test_benchmark():
    ...
    stage_2_node_ip = g5_12xlarge_ip_2
    stage_3_node_ip = g6e_xlarge_ip_2

    stage_0_node_ip = g6e_xlarge_ip_1
    stage_1_node_ip = g5_12xlarge_ip_1
    stage_2_node_ip = g5_12xlarge_ip_1
    stage_3_node_ip = g5_12xlarge_ip_2
    stage_4_node_ip = g5_12xlarge_ip_2
    stage_5_node_ip = g6e_xlarge_ip_2
    ...
    pipeline_1_config = {
        ...
        "parallel_strategy": [1,2,2,2,2,1],
        "max_model_len": 8192,
        "max_num_batched_tokens": 8192,
        "max_num_seqs": 2048,
        "model_source": "s3",
        "s3_path": f"s3://hetero-spot-llm-serve-models/{model_name}",
        "num_gpu_blocks": 12250,
        "max_batch_size": 197,
    }
    estimated_throughput_1 = 0.27
