...
All pipelines loaded from predicted JSON, Azure Trace warmup (time_scale=5/3, 15s) (offline).
"""
import asyncio
...
# VL-P1: g6.12xl#1, g6.12xl#2, g6.12xl#3  (TP=4 each)
# VL-P2: g5.12xl#1, g5.12xl#2              (TP=4 each)
# VL-P3: g6e.xl#1, g6e.xl#2, g6e.xl#3, g6e.xl#4  (TP=1 each)
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"Offline Benchmark — vLLM — {PREDICTED_FILE}")
