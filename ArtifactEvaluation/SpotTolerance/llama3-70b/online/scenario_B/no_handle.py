"""
Online benchmark — No Handle spot tolerance (Llama-3.1-70B, Scenario B)
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "online_no_handle.json")
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Online Benchmark — No Handle Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_online_no_handle_llama3_70b_scenario_{SCENARIO}",
