"""
Offline benchmark — Warmup baseline (Qwen3-32B, Scenario B)
...
EXTRA_PIPELINES = [
    {
        ...
        "config": {
            ...
            "model_source": "s3",
            "s3_path": S3_PATH,
            "num_gpu_blocks": 20397,
            "max_batch_size": 328,
        },
        "node_layer_mapping": [
            ["spot_g6_12xlarge_node_ip_1", 22],
            ["spot_g6_12xlarge_node_ip_2", 21],
            ["spot_g6_12xlarge_node_ip_3", 21],
        ],
    },
    {
        "label": "WU-P6",
