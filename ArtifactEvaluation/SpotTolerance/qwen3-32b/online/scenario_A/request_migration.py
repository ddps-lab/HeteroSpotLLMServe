"""
Online benchmark — Request Migration spot tolerance (Qwen3-32B, Scenario A)
...
async def test_benchmark():
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_online_request_migration_qwen3_32b_scenario_{SCENARIO}",
