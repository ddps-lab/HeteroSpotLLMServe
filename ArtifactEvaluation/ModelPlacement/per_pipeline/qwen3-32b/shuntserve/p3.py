...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "shuntserve_p3.json")

# ─── Node assignment ─────────────────────────────────────────────────
# SS-P3: g5.12xlarge×1 (single node, TP=4)
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"ShuntServe Pipeline 3 — {PREDICTED_FILE}")
