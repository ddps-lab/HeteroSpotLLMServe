...
# Check _pipeline["stages"] to see instance types and layer counts.
# Adjust mapping based on HexGen's stage assignments.
NODE_LAYER_MAPPING = [
    ...
    (g6_12xlarge_node_ip_1, int(_pipeline["stages"][3][STAGE_LAYER_COUNT_IDX])),
    ...
    (g6e_xlarge_node_ip_2,  int(_pipeline["stages"][6][STAGE_LAYER_COUNT_IDX])),
    (g6e_xlarge_node_ip_3,  int(_pipeline["stages"][7][STAGE_LAYER_COUNT_IDX])),
]
