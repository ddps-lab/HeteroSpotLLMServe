...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "bench_p4d_24xlarge_tp2_pp4.json")
...
NODE_LAYER_MAPPING = [
    # stage[0]: 7 layers (TP=2)
    (NODE_IP, 7),
    # stage[1]: 7 layers (TP=2)
    (NODE_IP, 7),
    # stage[2]: 7 layers (TP=2)
    (NODE_IP, 7),
    # stage[3]: 7 layers (TP=2)
    (NODE_IP, 7),
]
...
async def test_benchmark():
    ...
    print(f"  Strategy: TP=2, PP=4 → {PARALLEL_STRATEGY}")
