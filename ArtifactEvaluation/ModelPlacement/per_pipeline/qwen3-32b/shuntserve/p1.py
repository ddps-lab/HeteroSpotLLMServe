...
PREDICTED_FILE = [f for f in os.listdir(PREDICTED_DIR) if f.startswith("predicted_shuntserve_")][0]
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "shuntserve_p1.json")

# ─── Node assignment ─────────────────────────────────────────────────
# SS-P1: g6e.xlarge×4 (homogeneous, TP=1 each)
