...
# ─── Node assignment ─────────────────────────────────────────────────
# AP-P2: g6.12xlarge (single node, TP=4)

NODE_LAYER_MAPPING = [
    (g6_12xlarge_node_ip_2, int(_pipeline["stages"][0][STAGE_LAYER_COUNT_IDX])),  # g6.12xlarge TP=4
]
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"AlpaServe Pipeline 2 — {PREDICTED_FILE}")
