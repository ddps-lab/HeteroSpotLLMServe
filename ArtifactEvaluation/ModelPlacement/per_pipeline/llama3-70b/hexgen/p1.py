...
NODE_LAYER_MAPPING = [
    ...
    (g6e_xlarge_node_ip_1, int(_pipeline['stages'][0][STAGE_LAYER_COUNT_IDX])),
    # stage[1]: (spot)g6e.xlarge (TP=1, 1 GPU)
    (g6e_xlarge_node_ip_2, int(_pipeline['stages'][1][STAGE_LAYER_COUNT_IDX])),
    # stage[2]: (spot)g6e.xlarge (TP=1, 1 GPU)
    (g6e_xlarge_node_ip_3, int(_pipeline['stages'][2][STAGE_LAYER_COUNT_IDX])),
    # stage[3]: (spot)g5.12xlarge(half) (TP=2, 2 GPU)
    (g5_12xlarge_node_ip_1, int(_pipeline['stages'][3][STAGE_LAYER_COUNT_IDX])),
    ...
    # stage[6]: (spot)g5.xlarge (TP=1, 1 GPU)
    (g5_12xlarge_node_ip_2, int(_pipeline['stages'][6][STAGE_LAYER_COUNT_IDX])),
    # stage[7]: (spot)g5.xlarge (TP=1, 1 GPU)
    (g5_12xlarge_node_ip_2, int(_pipeline['stages'][7][STAGE_LAYER_COUNT_IDX])),
    # stage[8]: (spot)g5.xlarge (TP=1, 1 GPU)
    (g5_12xlarge_node_ip_2, int(_pipeline['stages'][8][STAGE_LAYER_COUNT_IDX])),
]
