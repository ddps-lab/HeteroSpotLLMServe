"""
Offline benchmark — No Handle spot tolerance (Llama-3.1-70B long-context / Mooncake, Scenario A)
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Offline Benchmark — No Handle Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_offline_no_handle_llama3_70b_scenario_{SCENARIO}",
