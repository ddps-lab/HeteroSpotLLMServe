"""
Online benchmark — Concurrent Initialization spot tolerance (Llama-3.1-70B, Scenario A)
...
OUTPUT_PATH = os.path.join(OUTPUT_DIR, "online_concurrent_initialization.json")
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Online Benchmark — Concurrent Initialization Spot Tolerance — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_online_concurrent_initialization_llama3_70b_scenario_{SCENARIO}",
