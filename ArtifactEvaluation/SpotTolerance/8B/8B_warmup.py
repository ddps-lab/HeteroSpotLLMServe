...
async def main():
    ...
    pipeline_1_stage_2_node_ip = spot_g6_xlarge_node_ip_3
    pipeline_1_config = {
        "model_name": model_name,
        "total_num_layers": 32,
        "gpu_memory_utilization": 0.85,
        "pp_layer_partition": "11,11,10",
        "parallel_strategy": [1,1,1],
        "max_model_len": 8192,
    ...
    node_layer_mapping_1 = [
        (pipeline_1_stage_0_node_ip, 11),
        (pipeline_1_stage_1_node_ip, 11),
        (pipeline_1_stage_2_node_ip, 10),
    ]

    # Pipeline 2
    pipeline_2_stage_0_node_ip = ondemand_g6_xlarge_node_ip_1
    pipeline_2_stage_1_node_ip = ondemand_g6_xlarge_node_ip_2
    pipeline_2_config = {
        "model_name": model_name,
        "total_num_layers": 32,
        "gpu_memory_utilization": 0.85,
    ...
    node_layer_mapping_2 = [
        (pipeline_2_stage_0_node_ip, 16),
        (pipeline_2_stage_1_node_ip, 16),
    ]
    ...
    try:
        ...
        end_time = 2 * 60  # Run for 2 minutes
