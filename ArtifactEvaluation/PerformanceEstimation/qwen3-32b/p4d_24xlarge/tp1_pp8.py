...
NODE_LAYER_MAPPING = [
    # stage[0]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[1]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[2]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[3]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[4]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[5]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[6]: 8 layers (TP=1)
    (NODE_IP, 8),
    # stage[7]: 8 layers (TP=1)
    (NODE_IP, 8),
]
