"""
AlpaServe Pipeline 5 (qwen3-32b)
...
NODE_LAYER_MAPPING = [
    # stage[0]: (spot)g5.12xlarge (TP=4) — replica 2
    (g5_12xlarge_node_ip_2, int(_pipeline['stages'][0][STAGE_LAYER_COUNT_IDX])),
]
...
async def test_benchmark():
    ...
    print("=" * 70)
    print(f"AlpaServe Pipeline 5 — Config loaded from {PREDICTED_FILE}")
