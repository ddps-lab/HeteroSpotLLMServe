"""
Offline benchmark — On-Demand Only baseline (Qwen3-32B, Scenario B)
...
async def test_benchmark():
    ...
    logger.info("=" * 70)
    logger.info(f"Offline Benchmark — On-Demand Only Baseline — Scenario {SCENARIO}")
    ...
    try:
        ...
        metrics = await run_trace_benchmark(
            ...
            trace_output_prefix=f"spottolerance_offline_only_ondemand_qwen3_32b_scenario_{SCENARIO}",
