...
OUTPUT_PATH = os.path.join(RESULTS_DIR, "bench_g6e_48xlarge_tp1_pp8.json")
...
# Fill in the IP address of the g6e.48xlarge node.
...
async def test_benchmark():
    ...
    print(f"  Instance: g6e.48xlarge (L40S ×8)")
