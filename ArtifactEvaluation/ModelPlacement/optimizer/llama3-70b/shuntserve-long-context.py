...
def main():
    ...
    config = {
        "expected_input_len": 5745,
        "expected_output_len": 154,
    ...
    print("=" * 80)
    print("ShuntServe Optimizer — Iterative Pipeline Search (LONG CONTEXT)")
    print(f"Model: {model_name}")
    print(f"Workload: input_len={config['expected_input_len']}, "
          f"output_len={config['expected_output_len']}, max_model_len={config['max_model_len']}")
    ...
    output_file = os.path.join(results_dir, f"predicted_shuntserve_{model_short}-long-context.json")
